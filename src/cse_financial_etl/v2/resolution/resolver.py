    ...
    for candidate in candidates:
        ...
        facts.append(
            SourceFact(
                ...
                source_concept=candidate.concept.source_concept,
                matched_alias=candidate.concept.matched_alias,
                accounting_regime=candidate.concept.accounting_regime,
                accounting_regime_status=candidate.concept.accounting_regime_status,
