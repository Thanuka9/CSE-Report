"""Dependency-neutral publication contract shared by all output surfaces."""
...
STOCK_METRIC_CODES = frozenset(
    {"TOTAL_ASSETS", "TOTAL_EQUITY", "TOTAL_LIABILITIES", "NAVPS"}
)
...
def set_release_mode(mode: str) -> str:
    """Configure the process-wide release mode."""
...
def publishability_decision(
    ...
    *,
    ...
    """Return the single fail-closed publication decision for every output surface."""
...
def is_publishable_fact(
    ...
    *,
    ...
    return publishability_decision(
        fact,
        require_quarter_flow=require_quarter_flow,
